...
def seq2seq_generator(x_path: str, y_path: str, batch_size: int = 256, shuffle: bool = True) -> tf.data.Dataset:
    """
    ...
    :param x_path: Path of a csv file that contains X
    :param y_path: Path of a csv file that contains y
